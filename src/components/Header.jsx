  ...
  return (
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4  ">
        <a className=" w-[8rem] xl:mr-8 flex flex-row items-center" href="#hero">
          <img src={brainwave} width={80} height={20} alt="Brainwave" />
          <span className="text-white text-3xl font-bold"> HackWorldInc</span>
        </a>

        <nav
          className={`${openNavigation ? "flex" : "hidden"
            } fixed top-[5rem] pl-12 left-0 right-0 bottom-0 bg-n-8 lg:static lg:flex lg:mx-auto lg:bg-transparent`}
        >
